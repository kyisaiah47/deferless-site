...
if (!base) { console.error('verify-cf: no base url given'); process.exit(1); }
...
if (failed) { console.error(`verify-cf: ${failed} route(s) did not answer as expected`); process.exit(1); }
